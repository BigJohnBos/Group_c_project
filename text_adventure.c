...
int forward(void){
    ...
    printf("Once you get to the town you see a small cafe, they have a sign saying 'Free Wifi'. You could go inside use your phone, or you could keep walking and try to figure out where you are. Which do you do?(hin, say cafe or struggle)\n");
    while(rv==1){
        scanf("%s", &answer);
        if(strcmp(answer, "Cafe")==0){
            ...
            printf("Your mom has been worried sick, she comes to get you and bring you home, she had filed a missing persons report for you, apperently you had been gone for a while.\n");
...
int right(void){
    ...
    while(joe == 1){
        if (strcmp(answer, "yes")==0){
            ...
            printf("[ENDING 3/8]")/*cc did this part, bb helped her with most*/;
            joe= 0;
        }else if (strcmp(answer, "no")==0){
